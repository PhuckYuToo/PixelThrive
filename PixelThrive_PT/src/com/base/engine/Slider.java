...
public class Slider
{
	...
	public void render(Vector2f offset)
	{
		...
		if(font != null)
		{
			...
			Render.drawString(pos.add(finPos).add(textOffs).sub(offset), text, new Color(0xFFFFFF), font, new Vector2f(3));
		}
		...
		if(font2 != null)
		{
			...
			Render.drawString(sliderVec, num, new Color(numR, numG, numB), font, new Vector2f(3));
		}
		Render.popMatrix();
	}
